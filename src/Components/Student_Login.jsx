    ...
    return (
        ...
        <div className='max-w-[100%] h-screen bg-gradient-to-br from-blue-300 via-transparent to-blue-50 py-7'>
            <form className="max-w-sm mx-auto p-4" onSubmit={loginUser} autoComplete='off'>
                ...
                <button type="submit" className="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 my-4 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Click to Start Quiz</button>
            </form>
