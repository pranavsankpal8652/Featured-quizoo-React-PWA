           ...
           <ul className="divide-y divide-gray-200 dark:divide-gray-700">
             <li className="py-3 sm:py-4">
               <div className="flex items-center space-x-4">
                 ...
                 <div className="min-w-0 flex-1">
                   <label for={`{${quiz.title}A}`} className="truncate text-sm font-medium text-gray-900 dark:text-white cursor-pointer">{quiz.option1}</label>
                 </div>
             ...
             <li className="py-3 sm:py-4">
               <div className="flex items-center space-x-4">
                 ...
                 <div className="min-w-0 flex-1">
                   <label for={`{${quiz.title}B}`} className="truncate text-sm font-medium text-gray-900 dark:text-white cursor-pointer">{quiz.option2}</label>
                 </div>
             ...
             <li className="py-3 sm:py-4">
               <div className="flex items-center space-x-4">
                 ...
                 <div className="min-w-0 flex-1">
                   <label for={`{${quiz.title}C}`} className="truncate text-sm font-medium text-gray-900 dark:text-white cursor-pointer">{quiz.option3}</label>
                 </div>
             ...
             <li className="py-3 sm:py-4">
               <div className="flex items-center space-x-4">
                 ...
                 <div className="min-w-0 flex-1">
                   <label for={`{${quiz.title}D}`} className="truncate text-sm font-medium text-gray-900 dark:text-white cursor-pointer">{quiz.option4}</label>
                 </div>
